...
PATH_TO_HEXLET_TEST_JSON = 'difference_calculator/tests/fixtures/hexlet_test.json'
PATH_TO_FAILURE_TEST_JSON = 'difference_calculator/tests/fixtures/fail_test.json'

PATH_TO_FILE1_YML = 'difference_calculator/file1.yml'
PATH_TO_FILE2_YML = 'difference_calculator/file2.yml'
PATH_TO_HEXLET_TEST_YML = 'difference_calculator/tests/fixtures/hexlet_test.yml'
PATH_TO_FAILURE_TEST_YML = 'difference_calculator/tests/fixtures/failure_test.yaml'
